...
[^2]: To deploy Spring Framework PetClinic to WebLogic 15.1.1 (BETA), **first** follow the app migration [tutorial](https://github.com/oracle-samples/weblogic-examples/blob/main/tutorials/migrate/spring-framework-petclinic-15.1.1/README.md), then follow either deploy to [containerized](/tutorials/deploy/petclinic-in-container-14.1.2/README.md) or [traditional-weblogic](/tutorials/deploy/deploy-petclinic-weblogic-12.2.1.4/README.md) tutorial.
